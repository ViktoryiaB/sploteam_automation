...
public class SploteamTest_Victoria_Diplom_oldn {
    ...
    */
    ...
    public void CreateAndCancelOwnGameFutureDateSetFilters () { //Test #3 Создать и удалить игру в Личном кабинете на определенную дату (на 8-й день, считая от сегодня, предварительное условие - наличие свободных слотов для создания игры);
        ...
        arenaFilter.click();
        String selectedArena = driver.findElements(By.className(ARENA_FILER_OPTIONS_CLASS)).get(1).getText();
        driver.findElements(By.className(ARENA_FILER_OPTIONS_CLASS)).get(1).click();
        ...
        String selectedplayerklevelFilter = driver.findElements(By.className(PLAYER_LEVEL_FILTER_OPTIONS_CLASS)).get(1).getText();
        driver.findElements(By.className(PLAYER_LEVEL_FILTER_OPTIONS_CLASS)).get(1).click();
        assertEquals(selectedplayerklevelFilter, playerlevelFilter.getText());
    ...
    public void districtsdatamassivecheckSanktPetersburgSurvey () throws InterruptedException  {
        ...
        // конвертируем массив в List методом Arrays.asList
    ...
    public void clickThroughTimesAndCheckBoxesAvailableOnPageSurvey () throws InterruptedException  { //Test #4
        ...
        //wait.until(ExpectedConditions.presenceOfElementLocated(By.className(PROFILE_HEADER_CLASS)));
        ...
        // находим все элементы по классу похожие на временные слоты
        ...
        // Прохожу по всем найденным элементам и пробую из кликать - если успешно - увеличиваю счетчик
        ...
        // Сравниваем число найденных чекбоксов  и число нажатых (счетчик i)
    ...
    public void createGame () throws InterruptedException {
        ...
        driver.findElement(By.xpath(INPUT_FORM_EMAIL_XPATH)).sendKeys("stn08101989@gmail.com");
        driver.findElement(By.xpath(INPUT_FORM_PASSWORD_XPATH)).sendKeys("newPassword1");
        driver.findElements(By.className ("button")).get(4).click();
        driver.findElement(By.xpath(MORE_GAME_BUTTON_XPATH)).click();
        driver.findElements(By.className(DATE_PICKER_CLASS)).get(5).click();
        sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div/div[2]/div[1]/div/div[2]")).click();
        sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div/div[4]/div/div[1]/div[2]/div[1]/div[1]")).click();
        sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div/div[4]/div/div[1]/div[3]/div[2]/div")).click();
        driver.findElements(By.className("Select_dropdownItem__2T2FU")).get(5).click();
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div/div[4]/div/div[1]/div[3]/div[4]/button")).click();
        driver.findElement(By.className("react-select__single-value")).click();
        driver.findElements(By.className("react-select__option")).get(2).click();
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/div[2]/form/div[3]/div/div/div[1]/div")).click();
        driver.findElements(By.className("react-select__option" )).get(1).click();
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/div[2]/form/div[4]/div/div/div[1]/div")).click();
        driver.findElements(By.className("react-select__option" )).get(1).click();
    }
